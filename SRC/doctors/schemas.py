...
class doctab(Base):
    ...
    proffession=Column(VARCHAR(500),nullable=False)
    password=Column(VARCHAR(500),nullable=False)
    emg_cont=Column(CHAR(100),unique=True,nullable=False)
    hospital_name=Column(String,nullable=False)
    ref_token=Column(VARCHAR(500),nullable=False)
    img_url=Column(VARCHAR(500),default="https://png.pngtree.com/png-vector/20240122/ourmid/pngtree-doctor-symbol-color-png-image_11455717.png")
